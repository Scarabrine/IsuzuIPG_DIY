...
W = 0.77*2 #[m] width of vehicle
LF = 3.46-0.79 #[m] distance from rear to vehicle front end of vehicle
LB = 0.79 #[m] distance from rear to vehicle back end of vehicle
